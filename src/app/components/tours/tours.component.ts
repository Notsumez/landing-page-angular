...
export class ToursComponent {
  cards = [
    ...
    { id: 4, image: 'tour-rio.jpg', name: 'Arraial do Cabo', time: '10 hours', extra: 'Air-conditioned transport • Boat ride • Lunch Included', local: 'Rio de Janeiro - Brazil', type: '1 day tour', price: '€49,58 per person' }
  ];
